...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RxAlamofire-framework/RxAlamofire.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwinjectAutoregistration-framework/SwinjectAutoregistration.framework"
fi
